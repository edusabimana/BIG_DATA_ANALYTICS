...
try:
    ...
    users_df = spark.read.json(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\data\users.json").limit(1000)
...
try:
    ...
    if df.empty:
        ...
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\sales_by_category_spark.png")
...
try:
    ...
    sessions_df = spark.read.json(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\data\sessions_0.json").limit(50000)
    sessions_df.cache()
    ...
    if funnel_df.empty:
        ...
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\conversion_funnel.png")
...
try:
    ...
    if top_products.empty:
        ...
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\top_products.png")
...
try:
    ...
    if sales_over_time.empty:
        ...
        plt.tight_layout()
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\sales_over_time.png")
        ...
        try:
            ...
            if write_to_hbase_with_retry(table, data):
                print("Wrote sales over time to HBase")
            else:
...
try:
    ...
    if mongo_df.empty:
        ...
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\revenue_by_category_mongo.png")
...
try:
    ...
    if segment_df.empty:
        ...
        try:
            plt.savefig(r"D:\Personal\masters\BIG DATA ANALYTICS\E_COMMERCE_ANALYTICS\visualizations\user_segmentation.png")
...
try:
    ...
    users_df.unpersist()
    sessions_df.unpersist()  # Unpersist sessions_df if cached
